...
var CalWidth=140;// calendar width
...
function RenderCssCal(bNewCal) {
    ...
    vCalHeader="<table "+CalBgColor+" background='"+ThemeBg+"' border=0 cellpadding=0 cellspacing=0 width='140' valign='top'>\n";
    ...
    if (Cal.ShowTime)
    {
        ...
        var HourCellWidth="5px"; //cell width with seconds.
    ...
    {
        vCalTime+="<span id='close_cal' title='close' onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\");' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white; font-family: Arial;font-size: 10pt;'>close</span></td>";
    }
    ...
    if (winCal == undefined) {
        ...
        var cssStr = ".calTD {font-family: verdana; font-size: 11px; text-align: center;}\n";
        cssStr+= ".calR {font-family: verdana; font-size: 11px; text-align: center; font-weight: bold; color: red;}"
        ...
        span.id = calSpanID;
        with (span.style) {
            position = "absolute"; left = (xpos+8)+'px'; top = (ypos-8)+'px'; width = CalWidth; border = "solid 2pt " + SpanBorderColor; padding = "0pt"; cursor = "move"; backgroundColor = SpanBgColor; zIndex = 100;
          //  display:"block";float:""; position:"fixed"; width = CalWidth; border = "solid 2pt " + SpanBorderColor; padding = "0pt"; cursor = "move"; backgroundColor = SpanBgColor; zIndex = 100;
        }
