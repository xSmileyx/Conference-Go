...
<div class="wrapper row1" >
  <header id="header"  class="hoc clear"> 
    <div id="logo" class="fl_left">
      <h1><a href="dashboard.php">Conference management system</a></h1>
	</div>
...
<form action="dashedit.php" method="post" name="dashmodify" enctype="multipart/form-data">
<!-- Top Background Image Wrapper -->
<div class="bgded" style="background-image:url(uploads/<?php echo $result['banner_image']?>)"/>

<input type="file" name="banner_image" class="twitter" style="color:black;" value="<?php echo $result['banner_image'];?>" />
