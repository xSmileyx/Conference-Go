...
<!--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
		...
		<button onclick="location.href ='../test/chooseConf.php';" style="width:300px;" class="button"><< Back to conference selection</button>
							<input type="submit" name="Submit" style="width:400px; float:right;" value="Proceed to Participation / Booking Summary >" class="button" onclick="return confirm('Are you sure?');">
</fieldset>
