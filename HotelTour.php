...
<!--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
		...
		<button onclick="location.href ='../test/chooseConf.php';" style="width:250px;" class="backButton"><< Back to conference selection</button>
							<input type="submit" name="Submit" style="width:400px;" value="Proceed to Participation / Booking Summary >" class="myButton" onclick="return confirm('Are you sure?');">
</fieldset>
