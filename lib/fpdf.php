...
*                                                                              *
*******************************************************************************/
function FPDF($orientation='P', $unit='mm', $format='A4', $height)
{
	//Some checks
	$this->_dochecks();
	...
	$this->PageFormats=array('a3'=>array(841.89,1190.55), 'a4'=>array(595.28,841.89), 'a5'=>array(420.94,595.28),
		'letter'=>array(612,792), 'legal'=>array(612,1008), 'receipt'=>array(221,$height), 'cheque'=>array(499.45,250.62) , 'barcode'=>array(65, 1270));
	if(is_string($format))
